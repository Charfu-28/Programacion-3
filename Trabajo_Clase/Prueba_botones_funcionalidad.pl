...
resource(imagen1,image,image('1.jpg')).
resource(imagen2,image,image('2.jpg')).
...
volver:- new(Dialogo, dialog('Mi primera Interfaz')),
   ...
   new(Boton3, button('Volver',message(@prolog,volver))),
   ...
   send_list(Dialogo, append, [Etiqueta,EtiquetaImg,Texto1,Texto2,Texto3,Boton1,Boton2,Boton3]),
   send(Dialogo, open).
